            ...
            <div className="col-md-6 col-lg-4">
              <FadeInSection>
                <div className="hvr-bounce-in cardCustom">
                  ...
                  <p>
                    Dance, Singing, Music, Films & Theatre, Story telling, Magic
                    Shows, Stand-up Comedies
                  </p>
                </div>
              </FadeInSection>
            </div>
            <div className="col-md-6 col-lg-4">
              <FadeInSection>
                <div className="hvr-bounce-in cardCustom">
                  ...
                  <p>
                    Drawing, Painting, Writing, photography, designing
                    Calligraphy, Sculpture etc
                  </p>
                </div>
              </FadeInSection>
            </div>
            <div className="col-md-6 col-lg-4 mg-auto">
              <FadeInSection>
                <div className="hvr-bounce-in cardCustom">
                  ...
                  <p>
                    Fashion design, Interior Design, Jewelry Design, Wood Crafts
                    etc
                  </p>
                </div>
              </FadeInSection>
